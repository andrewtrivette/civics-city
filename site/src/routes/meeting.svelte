...
onMount(() => {
    ...
    var meetingID = parseInt(params.get('agenda')) || parseInt(params.get('minutes'));
    ...
    get( url, function(result) 
    {
        ...
        d.getElementById('title').innerHTML = result.Meeting.Department.Name+' '+type;
        d.getElementById('subtitle').innerHTML = meetingDate;
