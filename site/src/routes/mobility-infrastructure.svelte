<svelte:head>
    ...
    crossorigin=""></script>
    <script src="https://unpkg.com/leaflet-webgl-heatmap@0.2.7/src/webgl-heatmap/webgl-heatmap.js"></script>
    <script src="https://unpkg.com/leaflet-webgl-heatmap@0.2.7/dist/leaflet-webgl-heatmap.min.js"></script>
...
<div class="container mt-4">
    <div class="row">
		<div class="col-12 text-center">
			<h1>Atlanta Cycling Infrastructure</h1>
        </div>
        <CyclingMap />
    </div>
</div>
...
<script>
import CyclingMap from '$lib/CyclingMap.svelte';
