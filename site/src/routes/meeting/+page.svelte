        ...
        <div class="container">
            <div class="row">
                {#if media }
                    ...
                    <div class="col-12 col-lg-6 mb-3">
                        <div class="media"><video controls preload="auto" src="{media}">
